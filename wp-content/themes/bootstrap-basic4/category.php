...
<div class="container py-5">
    <div class="row">
        <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-12">
                        ...
                        <div class="col-md-6 col-xl-6 col-xxl-6 col-12">
                            <div class="more-cover" style="height: 240px;">
                                ...
                                <div class="more-text">
                                    ...
                                    <div class="more-notice-category"><a href="<?php echo esc_url(get_term_link($categories[0]->term_id)); ?>"><?php echo single_cat_title(); ?></a></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="text-end"><a href="javascript:void(0)" data-admin-url-cat="<?php echo admin_url('admin-ajax.php'); ?>" data-not-in-posts-cat="<?php echo $do_not_duplicate_ajax_princ ?>" data-total-post="<?php echo $count; ?>" data-category="<?php echo $cat ?>" id="more_posts_category_princ" class="btn btn-orange rounded-0 px-4 py-2"><i class="fas fa-ellipsis-h fa-2x"></i></a></div>
