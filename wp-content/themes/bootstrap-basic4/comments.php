...
?> 
        <div class="col-12 col-sm-10">
            ...
            <section id="comments" class="comments-area">
                ...
                comment_form(
                    [
                        'class_submit' => 'btn btn-orange mt-4 rounded-0 float-end',


                        'fields' => [
                            'author' => '<div class="form-group row my-2">' .
                                '<div class="col-md-6">' .
                                '<input id="author" name="author" type="text" placeholder="Digite seu nome*" value="' . esc_attr($commenter['comment_author']) . '" size="30"' . $aria_req . ' class="form-control rounded-0" />' .
                                '</div>' .
                                '',
                            'email'  => '' .
                                '<div class="col-md-6">' .
                                '<input id="email" name="email"  placeholder="Digite seu e-mail*" ' . ($html5 ? 'type="email"' : 'type="text"') . ' value="' . esc_attr($commenter['comment_author_email']) . '" size="30"' . $aria_req . ' class="form-control rounded-0" />' .
                                '</div>' .
                                '</div>',
                            'url'    => '<div class="form-group row my-2">' .
                                '<div class="col-md-12">' .
                                '<input id="url"  placeholder="Digite seu site" name="url" ' . ($html5 ? 'type="url"' : 'type="text"') . ' value="' . esc_attr($commenter['comment_author_url']) . '" size="30" class="form-control rounded-0" />' .
                                '</div>' .
                                '</div>',
                            ...
                            '<div class="col-md-12">' .
                            '<textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" placeholder="Digite seu comentário*" class="form-control rounded-0"></textarea>' .
                            '</div>' .
                            '</div>',
                    ]
                );
